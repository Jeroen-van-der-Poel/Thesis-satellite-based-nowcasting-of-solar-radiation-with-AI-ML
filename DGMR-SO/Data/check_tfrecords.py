...
check_tfrecords('/data1/Thesis-satellite-based-nowcasting-of-solar-radiation-with-AI-ML/DGMR-SO/Data/train_data')
check_tfrecords('/data1/Thesis-satellite-based-nowcasting-of-solar-radiation-with-AI-ML/DGMR-SO/Data/val_data')
check_tfrecords('/data1/Thesis-satellite-based-nowcasting-of-solar-radiation-with-AI-ML/DGMR-SO/Data/test_data')

# check_black_samples_first_8_frames(
#     tfrecord_dir='/nobackup_1/users/meirink/Jeroen/Thesis-satellite-based-nowcasting-of-solar-radiation-with-AI-ML/DGMR-SO/Data/train_data',
#     value_threshold=0.0,
#     percent_thresh=0.5
# )

# check_black_samples_first_8_frames(
#     tfrecord_dir='/nobackup_1/users/meirink/Jeroen/Thesis-satellite-based-nowcasting-of-solar-radiation-with-AI-ML/DGMR-SO/Data/val_data',
#     value_threshold=0.0,
#     percent_thresh=0.5
# )
# check_black_samples_first_8_frames(
#     tfrecord_dir='/nobackup_1/users/meirink/Jeroen/Thesis-satellite-based-nowcasting-of-solar-radiation-with-AI-ML/DGMR-SO/Data/test_data',
#     value_threshold=0.0,
#     percent_thresh=0.5
# )