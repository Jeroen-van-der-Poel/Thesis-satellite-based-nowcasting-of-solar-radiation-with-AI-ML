...
## Comparision
To comapre DGMR-SO, EarthFormer and Persistence, we created a evaluation script which evaluates all models on the metrics defined in the report. Furthermore, it generates the images produced and sevs them as PNGs.
